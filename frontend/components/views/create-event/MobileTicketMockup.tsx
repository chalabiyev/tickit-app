...
interface MobileTicketMockupProps {
  eventName?: string
  location?: string
  date?: string
  startTime?: string
...
export function MobileTicketMockup({
  eventName,
  location,
  date,
  startTime,
}: MobileTicketMockupProps) {
  return (
    <div className="mx-auto w-full max-w-[280px]">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 px-5 py-8">
          ...
          <span className="font-mono text-[10px] text-muted-foreground tracking-[0.1em] mt-2">
            TKT-2026-XXXX
          </span>
        </div>
